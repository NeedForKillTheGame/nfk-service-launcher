...
<p>
<big>Банить по IP можно через файл <i>ipban.txt</i>, предварительно узнав адрес нарушителя в консоле командой <b>svinfo</b>, а затем <b>kickplayer</b> его через консоль. При следующем входе он зайти уже не сможет.
<br>Каждый забаненный IP адрес должен находиться в файле на новой строке. 
<br>Пустые строки, пробелы и левые символы справа от IP игнорируются. Можно добавлять комментарий к банам после двух слешей <i>// вот так</i>.
<br>При изменении на любом из серверов этот файл автоматически клонируется на все остальные!</big>
</p>
</div>
<br />
