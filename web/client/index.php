...
<br>Каждый забаненный IP адрес должен находиться в файле на новой строке (пустые строки и пробелы игнорируются).
<br>Можно добавлять комментарий к банам после двух слешей <i>// вот так</i>.
